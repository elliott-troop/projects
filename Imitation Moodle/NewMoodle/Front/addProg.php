...
if(isset($_POST['submit']))
{
   if (!$_POST['question'])
    ...
    $url = "web.njit.edu/~dp257/NewMoodle/Middle/addProgFromMiddle.php";
...
<h1 style="font-family: kodakku; font-size:52px; font-weight:bold;">Add Program  </h1>
...
<form method ="POST" action="addProg.php" class="form">
<div class="form-group">Question(preferably ask them to create a function):<input class="form-control" type="text" name="question" ></div>
Feedback (Tips for Program):
...
<a href="addQuestion.php" class="btn btn-info" type="" name="Cancel">Cancel</a>
</form>
