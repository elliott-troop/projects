...
else
{
  ...
  $account = $_SESSION['acct'];
          ...
          $post = 'name='.$name;
           ...
           $url = "web.njit.edu/~dp257/NewMoodle/Middle/chooseTestMiddle.php";
...
<h1 style="font-family: kodakku; font-size:52px; font-weight:bold;">Take a Test</h1>
<form action="logout.php" method="post">
   ...
   <div  class="row">
        ...
        ?>
             ...
             <form action="successfulStudent.php" method="post">
               <button type="submit" name="submit"  class="btn-md btn-info" >GO BACK</button> 
            </form>
           </div>
