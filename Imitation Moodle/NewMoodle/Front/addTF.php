   ...
   if (!$_POST['question'])
      {
           echo ("<SCRIPT LANGUAGE='JavaScript'>
                   window.alert('You did not complete all of the required fields')
                    window.location.href='addTF.php'
                </SCRIPT>");
          die();
       }
    else
    ...
    $url = "web.njit.edu/~dp257/NewMoodle/Middle/addTFFromMiddle.php";
...
<h1 style="font-family: kodakku; font-size:52px; font-weight:bold;">Add True or False</h1>
...
<form method ="POST" action="addTF.php" class="form">
<div class="form-group">Question:<input class="form-control" type="text" name="question"  size="40"></div>
Correct Answer:
                  <div class="radio">
                     <label><input type="radio" name="correctAnswer" id="true" value="true" checked >True</label>
                     </div>
                     <div class="radio">
                       <label><input type="radio" name="correctAnswer" id="false" value = "false">False</label>
                     </div>
