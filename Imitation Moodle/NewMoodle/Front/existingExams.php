...
$post = 'name='.$name;
    ...
    $url = "web.njit.edu/~dp257/NewMoodle/Middle/existingExamsMiddle.php";
...
<h1 style="font-family: kodakku; font-size:52px; font-weight:bold;">Check Exams You've Made</h1>
